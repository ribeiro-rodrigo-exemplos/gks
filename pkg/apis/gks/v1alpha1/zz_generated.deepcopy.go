...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ControlPlaneMasterResources) DeepCopyInto(out *ControlPlaneMasterResources) {
	*out = *in
	out.ControlPlaneMasterResourcesRequests = in.ControlPlaneMasterResourcesRequests
	out.ControlPlaneMasterResourcesLimits = in.ControlPlaneMasterResourcesLimits
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ControlPlaneMasterResources.
func (in *ControlPlaneMasterResources) DeepCopy() *ControlPlaneMasterResources {
	if in == nil {
		return nil
	}
	out := new(ControlPlaneMasterResources)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ControlPlaneMasterResourcesValues) DeepCopyInto(out *ControlPlaneMasterResourcesValues) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ControlPlaneMasterResourcesValues.
func (in *ControlPlaneMasterResourcesValues) DeepCopy() *ControlPlaneMasterResourcesValues {
	if in == nil {
		return nil
	}
	out := new(ControlPlaneMasterResourcesValues)
	in.DeepCopyInto(out)
	return out
}
